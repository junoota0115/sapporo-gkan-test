Gws_Gkan_Attendance = function (el, options) {
  this.el = el;
  this.$el = $(el);
...
Gws_Gkan_Attendance.prototype.render = function() {
  var _this = this;
...
Gws_Gkan_Attendance.prototype.onPunchClicked = function(action, message) {
  if (! action) {
    return;
  }
...
Gws_Gkan_Attendance.prototype.onEditClicked = function(action, message) {
  if (!action) {
    return
  }
...
Gws_Gkan_Attendance.prototype.hideToolbar = function() {
  this.$toolbar.hide();
};

Gws_Gkan_Attendance.prototype.hideTooltip = function() {
  this.$el.find('.reason-tooltip .reason').hide();
};

Gws_Gkan_Attendance.prototype.onClickTime = function($cell) {
  this.onClickCell($cell, this.options.timeUrl);
};

Gws_Gkan_Attendance.prototype.onClickMemo = function($cell) {
  this.onClickCell($cell, this.options.memoUrl);
};
Gws_Gkan_Attendance.prototype.onClickWorkingTime = function($cell) {
  this.onClickCell($cell, this.options.workingTimeUrl);
};

Gws_Gkan_Attendance.prototype.setFocus = function($cell) {
...
Gws_Gkan_Attendance.prototype.isCellToday = function($cell) {
  return $cell.closest('tr').hasClass('current');
};

Gws_Gkan_Attendance.prototype.onClickCell = function($cell, urlTemplate) {
  this.hideTooltip();
