class Gws::Gkan::Attendance::HolidayWork::FilesController < ApplicationController
  ...
  def set_crumbs
    ...
    @crumbs << [ t('modules.gws/gkan/attendance/holiday_work'), gws_gkan_attendance_holiday_work_main_path ]
  end
