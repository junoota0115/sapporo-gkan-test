class Gws::Gkan::Manage::Work::WorkDaysController < ApplicationController
  include Gws::BaseFilter
  include Gws::CrudFilter

  model Gws::Gkan::Manage::Work::SearchWorkDay
  ...
  def set_crumbs
    ...
    @crumbs << [ t('modules.gws/gkan/manage/work/work_days'), { action: :index } ]
  end
