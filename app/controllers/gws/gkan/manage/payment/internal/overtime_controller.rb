class Gws::Gkan::Manage::Payment::Internal::OvertimeController < ApplicationController
  include Gws::BaseFilter
  include Gws::CrudFilter

  model Gws::Gkan::Manage::Payment::Internal::SearchOvertime
  ...
  def index
    ...
    send_enum @item.enum_csv, filename: "payment_internal_overtime_#{Time.zone.now.to_i}.csv"
  end
end
