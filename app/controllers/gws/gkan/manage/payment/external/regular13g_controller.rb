class Gws::Gkan::Manage::Payment::External::Regular13gController < ApplicationController
  include Gws::BaseFilter
  include Gws::CrudFilter

  model Gws::Gkan::Manage::Payment::External::SearchRegular13g
  ...
  def set_crumbs
    ...
    @crumbs << [ t('modules.gws/gkan/manage/payment/external/regular13g'), { action: :index } ]
  end
