class Gws::Gkan::Manage::Payment::External::ParttimeController < ApplicationController
  include Gws::BaseFilter
  include Gws::CrudFilter

  model Gws::Gkan::Manage::Payment::External::SearchParttime
  ...
  def set_crumbs
    ...
    @crumbs << [ t('modules.gws/gkan/manage/payment/external/parttime'), { action: :index } ]
  end
  ...
  def index
    ...
    send_enum @item.enum_csv, filename: "payment_external_parttime_#{Time.zone.now.to_i}.csv"
  end
end
