class Gws::Gkan::Manage::Payment::External::Regular21gController < ApplicationController
  include Gws::BaseFilter
  include Gws::CrudFilter

  model Gws::Gkan::Manage::Payment::External::SearchRegular21g
  ...
  def set_crumbs
    ...
    @crumbs << [ t('modules.gws/gkan/manage/payment/external/regular21g'), { action: :index } ]
  end
  ...
  def index
    ...
    send_enum @item.enum_csv, filename: "payment_external_regular21g_#{Time.zone.now.to_i}.csv"
  end
end
