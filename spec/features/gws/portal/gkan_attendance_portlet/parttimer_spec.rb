...
describe "gws_portal_circluar", type: :feature, dbscope: :example, js: true do
  ...
  context "basic" do
    ...
    it do
      ...
      expect(page).to have_css('.today .info .location', text: I18n.t("gws/gkan.views.etc"))
      within '.today .action .location' do
        wait_cbox_open { click_on I18n.t('ss.buttons.edit') }
      end
      wait_for_cbox do
      ...
      expect(page).to have_no_css('.today .info .night-shift')
