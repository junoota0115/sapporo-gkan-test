...
describe "gws_gkan_attendance_overtime_files", type: :feature, dbscope: :example, js: true do
  ...
  let(:index_path) { gws_gkan_attendance_overtime_files_path site }
  let(:show_path) { gws_gkan_attendance_overtime_file_path site, item }
  let(:edit_path) { edit_gws_gkan_attendance_overtime_file_path site, item }
  let(:delete_path) { delete_gws_gkan_attendance_overtime_file_path site, item }
